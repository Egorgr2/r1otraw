  ...
  return (
    <div className="flex flex-col gap-4 px-4 py-6">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-black uppercase tracking-tight mb-4 brand-text">r1otRaw</h1>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="border border-white/10 p-8 rounded-lg">
            ...
            <a
              ...
              className="text-sm text-white hover:text-red-600 transition-colors underline"
            >
          ...
          <div className="border border-white/10 p-8 rounded-lg">
            ...
            <p className="text-sm text-white/70">
              Обратиться: <a href="https://t.me/KOREAGRAVESS" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-600 transition-colors underline">@KOREAGRAVESS</a>
            </p>
          </div>
